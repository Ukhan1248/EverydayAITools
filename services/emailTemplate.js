                    ...
                    <tr>
                      <td class="content-cell">
                        <div class="f-fallback">
                          <h1>Hi ${name},</h1>
                          <p>Thanks for using Everyday AI Tools. This email is the receipt for your purchase. No payment is due.</p>
                          <p>This purchase will appear as “Everyday AI Tools" on your credit card statement for your ${brand} ending in ${last4}.</p>
                          <!-- Discount -->
