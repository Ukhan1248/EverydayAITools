...
export default async function handler(req, res) {
  const { name, title, experience, degrees, skills, titles, email } = req.body;
  ...
  const response = await openai.createCompletion({
    ...
    prompt: `Generate a Linkedin about me summary with the following info.\n\n Name: ${name} Current Title: ${title} Years of Experience: ${experience}: Degrees: ${degrees} Skills: ${skills} Additional titles: ${titles} `,
    temperature: 0,
    max_tokens: 400,
    top_p: 1,
