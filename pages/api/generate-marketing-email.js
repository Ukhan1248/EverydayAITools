...
export default async function handler(req, res) {
  const { subject, audience, product, offer, email } = req.body;
  ...
  const response = await openai.createCompletion({
    ...
    prompt: `Generate a marketing email with the following information: \n\n  Subject: ${subject}, Audience: ${audience}, Product: ${product},  Offer: ${offer}`,
    temperature: 0,
    max_tokens: 300,
    top_p: 1,
